      ...
      const formattedAnswers = Object.keys(selectedAnswers)
        .map((questionKey) => {
          const question = quiz.questions.find(
            (q) => (q._id || q.id).toString() === questionKey.toString()
          );
          ...
          const optionIndex = selectedAnswers[questionKey];
          const selectedAnswer = question.options[optionIndex]?.text || null;
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        ...
        {/* Question Card */}
        <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-2xl shadow-slate-200/50 p-6 mb-8 mt-4">
              ...
              return (
                ...
                >
                  <input
                    ...
                    value={index}
                    checked={isSelected}
                    onChange={() => handleOptionChange(questionKey, index)}
                    className="sr-only"
                  />
        ...
        <div className="mt-0 flex items-center justify-center gap-2 flex-wrap">
          {quiz.questions.map((q, index) => {
            ...
            const isAnsweredQuestion = Object.prototype.hasOwnProperty.call(selectedAnswers, key);
