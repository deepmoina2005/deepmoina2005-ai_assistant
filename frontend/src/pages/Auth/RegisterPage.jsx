...
import { ArrowLeft, ArrowRight, BrainCircuit, Lock, Mail, User, Eye, EyeOff } from "lucide-react";
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-emerald-200/60 rounded-3xl shadow-xl shadow-emerald-200/40 p-10">
          ...
          <div className="text-center">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-linear-to-br from-emerald-400 to-teal-500 shadow-lg shadow-emerald-500/30 mb-4">
              <BrainCircuit strokeWidth={2} className="text-white w-7 h-7" />
            </div>
          ...
          <form className="mt-8 flex flex-col gap-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <input
                  ...
                  onBlur={() => setFocusedField(null)}
                  className="w-full pl-10 pr-10 py-2.5 border border-emerald-200 rounded-lg
                  bg-white focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500
                  outline-none transition-all shadow-sm"
                />
                <button
            ...
            <button
              ...
              disabled:bg-emerald-400 cursor-pointer"
            >
              {loading ? (
