        ...
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center max-w-md">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-linear-to-r from-emerald-500 to-teal-500 text-white rounded-lg shadow-md hover:shadow-lg font-semibold"
            >
    ...
    <div className="min-h-screen relative">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <Button
            onClick={() => setIsUploadModalOpen(true)} // <-- capital C
      ...
      {isUploadModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="relative w-full max-w-lg bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slat-900/20 p-8">
            {/* Close button */}
            <button
            ...
            <form onSubmit={handleUpload} className="space-y-5">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  onClick={() => setIsUploadModalOpen(false)}
                  disabled={uploading}
                  className="flex-1 h-11 px-4 border border-slate-300 rounded-xl 
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
         ...
         transition-all duration-200"
            ...
            {/* Modal Header */}
            <div className="mb-6">
              <div className="w-12 h-12 rounded-xl bg-linear-to-r from-red-100 to-red-200 flex items-center justify-center mb-2">
                <Trash2
                  className="w-6 h-6 text-slate-900 tracking-tight"
                  strokeWidth={2}
                />
              </div>
              <h2 className="text-xl font-medium text-slate-900 tracking-tight">
           ...
           disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              <button
                ...
                disabled={deleting}
                className="flex-1 h-11 px-4 rounded-xl
           bg-linear-to-r from-red-400 to-red-700
           text-white text-sm font-semibold 
           hover:opacity-90 transition-all duration-200
           disabled:opacity-50 disabled:cursor-not-allowed
           flex items-center justify-center"
