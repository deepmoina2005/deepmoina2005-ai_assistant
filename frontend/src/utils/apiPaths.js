...
export const API_PATHS = {
  ...
  ARTICLE: {
    ...
    GET_ARTICLE_BY_ID: (articleId) => `/api/articles/${articleId}`,
    DELETE_ARTICLE_ID: (articleId) => `/api/articles/${articleId}`,
  },

  IMAGE: {
    GET_ALL_IMAGES: "/api/images",
    GET_IMAGE_BY_ID: (imageId) => `/api/images/${imageId}`,
    DELETE_IMAGE_ID: (imageId) => `/api/images/${imageId}`,
  },
